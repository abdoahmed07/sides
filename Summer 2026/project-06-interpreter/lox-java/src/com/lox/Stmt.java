...
// Statement AST nodes — mirrors Expr.java but for statements (things that don't produce values)
// Expressions produce values; statements produce side effects (print, assign, declare)
...
public abstract class Stmt {
    ...
    public static class Class extends Stmt {
        ...
        @Override public <R> R accept(Visitor<R> visitor) { return visitor.visitClassStmt(this); }
    }
    ...
    // Lox has a built-in print statement (simpler than adding a native function)
    ...
    // return value; — uses a Java exception for control flow (I thought this was weird at first,
    // but it makes sense: return can happen anywhere in the call stack)
    ...
    // while (cond) body — for loops desugar into while loops in the parser
